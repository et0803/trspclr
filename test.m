...
eyeBallCenter2PupilCenter = (pupilCenter - eyeBallCenter)/norm(pupilCenter - eyeBallCenter);
eyeBallCenter2CameraOpticalCenter = (opticalCenter - eyeBallCenter) / norm(opticalCenter - eyeBallCenter);
